...
class Velocity:
    ...
    def __init__(self):
        ...
        self.dx = random.uniform(1.0, 3.0)
        self.dy = random.uniform(1.0, 3.0)
...
class Ball:
    ...
    def __init__(self):
        ...
        self.center = Point()
        #self.center.x = random(0.0, 0.0)
        #self.center.y = random(0.0, 300.0)
    ...
    def draw(self):
        ...
        arcade.draw_circle_filled(self.center.x, self.center.y, self.radius, arcade.color.BITTER_LEMON)
    ...
    def restart(self):
        ...
        self.center.x = 0.0
        self.center.y = random.uniform(0.0, 200.0)
        self.velocity.dx = random.uniform(-5.0, 5.0)
        self.velocity.dy = random.uniform(-5.0, 5.0)
...
class Paddle:
    ...
    def draw(self):
        ...
        arcade.draw_rectangle_filled(self.center.x + 390, self.center.y, PADDLE_WIDTH, PADDLE_HEIGHT, arcade.color.BLACK)   
    
    def move_up(self):
        
        if self.center.y <= 275:
            self.center.y += 5 
